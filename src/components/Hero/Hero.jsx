...
function RobotModel() {
  ...
  useFrame((state) => {
    ...
    robotGroup.current.rotation.y +=
      (targetY - robotGroup.current.rotation.y) * 0.035;

    robotGroup.current.rotation.x +=
      (targetX - robotGroup.current.rotation.x) * 0.035;
  });
      ...
      >
        ...
        >
          ...
          <p className="hero-description">
            ...
            I build modern digital experiences by
            combining
